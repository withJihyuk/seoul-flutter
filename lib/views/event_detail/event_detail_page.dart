        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container(
                margin:
                    const EdgeInsets.symmetric(horizontal: 27, vertical: 19),
                height: 80,
                child: const Column(
              ...
              Container(
                ...
                padding: const EdgeInsets.only(left: 19, top: 17, bottom: 25),
                ...
                child: const Column(
                  ...
                  children: [
                    Text(
                      '이 행사는 세종문화회관에서 진행해요',
                      style:
                          TextStyle(fontFamily: pretendard_500, fontSize: 15),
                    ),
                    Text(
              ...
              Container(
                margin:
                    const EdgeInsets.symmetric(horizontal: 27, vertical: 45),
                child: Column(
                  children: [
                    Row(
